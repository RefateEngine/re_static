...
# how to use
まずは範囲を指定します<br>
`/function re_static:scan/pos1`<br>
...
<ol>
<li>ブロックタグ`re_static:interactive`に検知したいブロックidを追加します</li>
<li>`re_static:scan/z/register`に追記してリストへ記入するidを決めます</li>
<li>最後に`re_static:lock/z/apply`内を編集し、カスタム処理を実装します。</li>
</ol>